...
<?php
			...
			$tablecount = 0;
				...
				$Buffer.="<div class=left_area{$count}>";
                                ...
                                $Buffer.="<div class=recieve_shop_percent_2 id=s_per>{$table2['shopList'][0]['per']}<span id=percent_value></span>%</div>";
...
$Buffer.="<div class=right_area>";
                                ...
                                //画像など
                                $Buffer.="<div class=img-wrap><img class=recieve_list_photo src={$results[$i]['photo']['mobile']['l']} alt=shop_photo width=100%></div>";
